...
hi NonText guifg=#2e3440 ctermfg=237 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Normal guifg=#d8dee9 ctermfg=254 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi Pmenu guifg=#d8dee9 ctermfg=254 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi PmenuSbar guifg=#d8dee9 ctermfg=254 guibg=#434c5e ctermbg=239 gui=NONE cterm=NONE
hi PmenuSel guifg=#4c566a ctermfg=240 guibg=#88c0d0 ctermbg=110 gui=NONE cterm=NONE
...
hi SignColumn guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
...
hi StatusLine guifg=#eceff4 ctermfg=255 guibg=#323846 ctermbg=237 gui=NONE cterm=NONE
hi StatusLineNC guifg=#d8dee9 ctermfg=254 guibg=#323846 ctermbg=237 gui=NONE cterm=NONE
hi StatusLineTerm guifg=#88c0d0 ctermfg=110 guibg=#323846 ctermbg=237 gui=NONE cterm=NONE
hi StatusLineTermNC guifg=#d8dee9 ctermfg=254 guibg=#323846 ctermbg=237 gui=NONE cterm=NONE
...
hi VertSplit guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
...
hi htmlEndTag guifg=#81a1c1 ctermfg=109 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlH1 guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlH2 guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlH3 guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlH4 guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlH5 guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlH6 guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi LspDiagnosticsUnderlineWarning guifg=#ebcb8b ctermfg=222 guibg=NONE ctermbg=NONE gui=undercurl cterm=undercurl
hi LspDiagnosticsUnderlineError guifg=#bf616a ctermfg=131 guibg=NONE ctermbg=NONE gui=undercurl cterm=undercurl
hi LspDiagnosticsUnderlineInformation guifg=#88c0d0 ctermfg=110 guibg=NONE ctermbg=NONE gui=undercurl cterm=undercurl
hi LspDiagnosticsUnderlineHint guifg=#5e81ac ctermfg=67 guibg=NONE ctermbg=NONE gui=undercurl cterm=undercurl
hi LspDiagnosticsVirtualTextError guifg=#717883 ctermfg=243 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsVirtualTextHint guifg=#717883 ctermfg=243 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsVirtualTextInformation guifg=#717883 ctermfg=243 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsVirtualTextWarning guifg=#717883 ctermfg=243 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi NeogitDiffAdd guifg=#434c5e ctermfg=239 guibg=#394147 ctermbg=238 gui=NONE cterm=NONE
hi NeogitDiffAddHighlight guifg=#a3be8c ctermfg=144 guibg=#454f4f ctermbg=239 gui=NONE cterm=NONE
hi NeogitDiffDelete guifg=#434c5e ctermfg=239 guibg=#44414f ctermbg=238 gui=NONE cterm=NONE
hi NeogitDiffDeleteHighlight guifg=#bf616a ctermfg=131 guibg=#524552 ctermbg=239 gui=NONE cterm=NONE
hi NeogitDeleteRegion guifg=#d8dee9 ctermfg=254 guibg=#bf616a ctermbg=131 gui=NONE cterm=NONE
hi NeogitDiffContext guifg=#434c5e ctermfg=239 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi NeogitDiffContextHighlight guifg=#d8dee9 ctermfg=254 guibg=#434c5e ctermbg=239 gui=NONE cterm=NONE
hi NeogitHunkHeader guifg=#4c5b6f ctermfg=59 guibg=#3c4a61 ctermbg=239 gui=NONE cterm=NONE
hi NeogitHunkHeaderHighlight guifg=#2e3440 ctermfg=237 guibg=#88c0d0 ctermbg=110 gui=NONE cterm=NONE
...
hi NvimTreeFolderName guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi NvimTreeOpenedFolderName guifg=#88c0d0 ctermfg=110 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NvimTreeOpenedFile guifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NvimTreeIndentMarker guifg=#4c566a ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NvimTreeRootFolder guifg=#717883 ctermfg=243 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi IndentBlanklineChar guifg=#4c566a ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi IndentLineCurrent guifg=#81a1c1 ctermfg=109 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi BufferCurrent guifg=#d8dee9 ctermfg=254 guibg=#3b4252 ctermbg=238 gui=bold,italic cterm=bold,italic
hi BufferCurrentIndex guifg=#3b4252 ctermfg=238 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi BufferCurrentIcon guifg=NONE ctermfg=NONE guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#3b4252 ctermfg=238 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi BufferCurrentTarget guifg=NONE ctermfg=NONE guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferCurrentMod guifg=#d8dee9 ctermfg=254 guibg=#3b4252 ctermbg=238 gui=bold,italic cterm=bold,italic
hi BufferIconSeparator guifg=#2e3440 ctermfg=237 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi BufferInactive guifg=#717883 ctermfg=243 guibg=#2e3440 ctermbg=237 gui=bold,italic cterm=bold,italic
hi BufferInactiveIcon guifg=#717883 ctermfg=243 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferInactiveIndex guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferInactiveMod guifg=#717883 ctermfg=243 guibg=#2e3440 ctermbg=237 gui=bold,italic cterm=bold,italic
hi BufferInactiveSign guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferTypeSeparator guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferTabpageFill guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferTabpages guifg=#2e3440 ctermfg=237 guibg=#2e3440 ctermbg=237 gui=NONE cterm=NONE
hi BufferVisible guifg=#d8dee9 ctermfg=254 guibg=#3b4252 ctermbg=238 gui=bold,italic cterm=bold,italic
hi BufferVisibleIcon guifg=#d8dee9 ctermfg=254 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi BufferVisibleIndex guifg=#2e3440 ctermfg=237 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#d8dee9 ctermfg=254 guibg=#3b4252 ctermbg=238 gui=bold,italic cterm=bold,italic
hi BufferVisibleSign guifg=#3b4252 ctermfg=238 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi BufferVisibleTarget guifg=#3b4252 ctermfg=238 guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi CursorWord guifg=NONE ctermfg=NONE guibg=#3b4252 ctermbg=238 gui=NONE cterm=NONE
hi LspDiagnosticsSignError guifg=#4c566a ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsSignWarning guifg=#4c566a ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsSignHint guifg=#4c566a ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsSignInformation guifg=#4c566a ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi rubyClass guifg=#81a1c1 ctermfg=109 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi rubyClassName guifg=#d8dee9 ctermfg=254 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi rubyConstant guifg=#88c0d0 ctermfg=110 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi rubyDefine guifg=#81a1c1 ctermfg=109 guibg=NONE ctermbg=NONE gui=bold,italic cterm=bold,italic
