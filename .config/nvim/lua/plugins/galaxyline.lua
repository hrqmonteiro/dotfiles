...
gl.short_line_list = {"LuaTree", "packager", "Floaterm", "NeogitStatus"}
...
section.short_line_left[1] = {BufferIcon = {provider = 'BufferIcon', highlight = {colors.nord8, colors.nordbg}}}
