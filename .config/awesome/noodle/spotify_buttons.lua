...
spotify_prev_symbol.font = "Victor Mono Nerd Font 18"
...
awesome.connect_signal("evil::spotify", function(artist, title)
    ...
    big_note.markup = helpers.colorize_text(play_symbol, accent)
    small_note.markup = helpers.colorize_text(pause_symbol, small_note_color)
